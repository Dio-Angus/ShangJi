...
namespace ChromatoCore.sample
{
    ...
    /// 样品信息视图
    /// </summary>
    public partial class SampleInfoViewer : SampleUs
    {
        ...
        /// </summary>
        /// <param name="am"></param>
        public SampleInfoViewer(AccessMethod am)
        {
            InitializeComponent();
            this._accessM = am;
        ...
        private void LoadEvent()
        {
            ...
            this.rbTcd1.CheckedChanged += new System.EventHandler(this.rbTcd1_CheckedChanged);
            this.rbTcd2.CheckedChanged += new System.EventHandler(this.rbTcd2_CheckedChanged);
            this.rbFid1.CheckedChanged += new System.EventHandler(this.rbFid1_CheckedChanged);
            this.rbFid2.CheckedChanged += new System.EventHandler(this.rbFid2_CheckedChanged);
        ...
        private void LoadViewOrSaveAs()
        {
            ...
            this.LoadRadioBtn();
            this.rbTcd1.Enabled = this.rbTcd1.Checked;
            this.rbTcd2.Enabled = this.rbTcd2.Checked;
        ...
        {
            switch (_dtoPara.ChannelID)
            {
                case IdChannel.Tcd1:
                    this.rbTcd1.Checked = true;
                    break;
                case IdChannel.Tcd2:
                    this.rbTcd2.Checked = true;
                    break;
                case IdChannel.Fid1:
                    this.rbFid1.Checked = true;
                    break;
                case IdChannel.Fid2:
                    this.rbFid2.Checked = true;
                    break;
            }
        ...
        public override bool ButtonDealer()
        {
            ...
            case AccessMethod.New:
                ...
                this._dtoPara.PathData = "db\\" + DateTime.Now.ToString("yyyyMM") + "\\"
                    + "通道" + _dtoPara.ChannelID + "_" + _dtoPara.RegisterTime + DefaultItem.Db_Extention;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void rbTcd1_CheckedChanged(object sender, EventArgs e)
        {
            this._dtoPara.ChannelID = IdChannel.Tcd1.ToString();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void rbTcd2_CheckedChanged(object sender, EventArgs e)
        {
            this._dtoPara.ChannelID = IdChannel.Tcd2.ToString();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void rbFid1_CheckedChanged(object sender, EventArgs e)
        {
            this._dtoPara.ChannelID = IdChannel.Fid1.ToString();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void rbFid2_CheckedChanged(object sender, EventArgs e)
        {
            this._dtoPara.ChannelID = IdChannel.Fid2.ToString();
        }
