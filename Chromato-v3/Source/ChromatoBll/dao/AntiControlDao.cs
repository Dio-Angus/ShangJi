...
namespace ChromatoBll.dao
{
    ...
    class AntiControlDao
    {
        ...
        public void GetMethodByID(AntiControlDto dto)
        {
            ...
            dto.dtoColumnPara = new ColumnParaDto();
            dto.dtoColumnPara.BalanceTime = Convert.ToSingle(ds.Tables[0].Rows[0]["BalanceTime"].ToString());
            dto.dtoColumnPara.InitTemp = Convert.ToSingle(ds.Tables[0].Rows[0]["tcpInitTemp"].ToString());
            dto.dtoColumnPara.MaintainTime = Convert.ToSingle(ds.Tables[0].Rows[0]["MaintainTime"].ToString());
            dto.dtoColumnPara.AlertTemp = Convert.ToSingle(ds.Tables[0].Rows[0]["tcpAlertTemp"].ToString());
            dto.dtoColumnPara.ColumnCount = Convert.ToSingle(ds.Tables[0].Rows[0]["ColumnCount"].ToString());
            dto.dtoColumnPara.RateCol1 = Convert.ToSingle(ds.Tables[0].Rows[0]["RateCol1"].ToString());
            dto.dtoColumnPara.RateCol2 = Convert.ToSingle(ds.Tables[0].Rows[0]["RateCol2"].ToString());
            dto.dtoColumnPara.RateCol3 = Convert.ToSingle(ds.Tables[0].Rows[0]["RateCol3"].ToString());
            dto.dtoColumnPara.RateCol4 = Convert.ToSingle(ds.Tables[0].Rows[0]["RateCol4"].ToString());
            dto.dtoColumnPara.RateCol5 = Convert.ToSingle(ds.Tables[0].Rows[0]["RateCol5"].ToString());
            dto.dtoColumnPara.TempCol1 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempCol1"].ToString());
            dto.dtoColumnPara.TempCol2 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempCol2"].ToString());
            dto.dtoColumnPara.TempCol3 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempCol3"].ToString());
            dto.dtoColumnPara.TempCol4 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempCol4"].ToString());
            dto.dtoColumnPara.TempCol5 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempCol5"].ToString());
            dto.dtoColumnPara.TempTimeCol1 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempTimeCol1"].ToString());
            dto.dtoColumnPara.TempTimeCol2 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempTimeCol2"].ToString());
            dto.dtoColumnPara.TempTimeCol3 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempTimeCol3"].ToString());
            dto.dtoColumnPara.TempTimeCol4 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempTimeCol4"].ToString());
            dto.dtoColumnPara.TempTimeCol5 = Convert.ToSingle(ds.Tables[0].Rows[0]["TempTimeCol5"].ToString());
