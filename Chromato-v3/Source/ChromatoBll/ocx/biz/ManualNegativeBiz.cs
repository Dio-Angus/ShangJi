/*-----------------------------------------------------------------------------
//  FILE NAME       : ManualNegativeBiz.cs
//  FUNCTION        : 手动画负峰翻转基线
//  AUTHOR          : 李锋(2009/12/08)
//  CHANGE LOG      : 
//  VERSION         : V1.0
//  ---------------------------------------------------------------------------
//---------------------------------------------------------------------------*/
...
namespace ChromatoBll.ocx.biz
{
    ...
    /// 手动画负峰翻转基线
    /// </summary>
    public class ManualNegativeBiz
    {
        ...
        /// 水平基线直线item
        /// </summary>
        public LineImp _negaBaseLine { get; set; }
        ...
        {
            this._negaBaseLine.StartX = X;
            this._negaBaseLine.EndX = X;
            this._negaBaseLine.StartY = Y;
            this._negaBaseLine.EndY = Y;
            this._negaBaseLine.Color = CastColor.GetCustomColor(Color.Red);
            this._negaBaseLine.Show = true;
        ...
        public PeakDto AddNewPeak(ArrayList arrPeak)
        {
            ...
            Single min = dtoStartAvg.Voltage;
