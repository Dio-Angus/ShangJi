    ...
    public class CommGas : CommBase
    {
        ...
        public override bool OpenLoop()
        {
            ...
            if (!_isRunLoop)
            {
                ...
                this._processThread = new Thread(DataProcessGasBoardThread);
                this._processThread.Name = "DataProcessGasBoardThread";
        ...
        /// 数据捕获线程
        /// </summary>
        private void DataProcessGasBoardThread()
        {

            DateTime dt = DateTime.Now;
            string tempTime = string.Format("DataProcessGasBoardThread Start: {0}:{1}:{2} {3}:{4}:{5} {6}",
            ...
            dt = DateTime.Now;
            tempTime = string.Format("DataProcessGasBoardThread Finished: {0}:{1}:{2} {3}:{4}:{5} {6}",
                dt.Year, dt.Month, dt.Day, dt.Hour, dt.Minute, dt.Second, dt.Millisecond);
            CastLog.Logger("CommPort", "DataProcessGasBoardThread", tempTime);
        ...
        private void DealWithGasVoltage(string oneFrame)
        {
            ...
            switch (oneFrame.Substring(2, 1))
            {
                ...
                case GasChannel.B:
                    ...
                    //CastLog.Logger("CommPort", "ProcessData",
                    //    String.Format("frame:{0}, 通道:3, time:{1}, value:{2}", oneFrame, dto.Moment, dto.Voltage));
                    break;
                ...
                case GasChannel.F:
                    ...
                    //CastLog.Logger("CommPort", "ProcessData",
                    //    String.Format("frame:{0}, 通道:4, time:{1}, value:{2}", oneFrame, dto.Moment, dto.Voltage));
                    break;
            }
        }
